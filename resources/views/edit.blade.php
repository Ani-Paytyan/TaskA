        ...
        <form action="" id="updateNewUser" method="put">
            <div class="user-details">
                <div class="input-box">
                    ...
                    <input type="text" name="name" class="name forEmptyError" value="{{$user->name}}"
                           placeholder="Մուտքագրել անուն, ազգանուն">
                </div>
                <div class="input-box">
                    <span class="details">Էլ․ հասցե</span>
                    <input type="text" name="email" class="email forEmptyError" value="{{$user->email}}"
                           placeholder="Մուտքագրել էլ․հասցե">
                </div>
                <div class="input-box">
                    <span class="details">Հեռախոսահամար</span>
                    <input type="text" name="phone" class="phone forEmptyError" value="{{$user->phone}}"
                ...
                <div class="input-box">
                    ...
                    <select class="input-box5 forEmptyError" name="role" id="SubjectsList" >
                        ...
                        <option class="details" value="manager" {{$user->role == 'manager'? 'selected': ''}}>Manager</option>
                        <option class="details" value="user" {{$user->role == 'user'? 'selected': ''}}>User</option>
                    </select>
                </div>
                <div class="input-box">
            ...
            <div class="gender-details">
                ...
                <input type="checkbox" name="active" id="switch"  value="{{$user->active}}" {{$user->active == 1? 'checked': ''}}><label for="switch">Toggle</label>
            </div>
            <div class="button">
                <input type="submit" id='createUser' value="Register">
            </div>
        </form>
    </div>
</div>
<script type="application/javascript">
    $(document).ready(function(){
        ...
        $("#createUser").click(function(e) {
            ...
            if ($("#SubjectsList :selected").val() == 0) {
